...
function loadClient() {
  gapi.client.setApiKey("AIzaSyApYCDyb5rKryce6V4oT2FGb6L1QW68EmM");
    ...
    .then(function (response) {
      ...
      if (response.status === 200) {
        return gapi.client.youtube.liveBroadcasts.bind({
          ...
          "streamId": "Nj87lCcakEkeQKniYUcJNA1646032700262929"
        })
          .then(function (response) {
            // Handle the results here (response.result has the parsed body).
            console.log("Response", response);
...
gapi.load("client:auth2", function () {
  gapi.auth2.init({ client_id: "782628737992-rvo1d5htv11qr89bvuphdvk399l3mano.apps.googleusercontent.com" });
});
